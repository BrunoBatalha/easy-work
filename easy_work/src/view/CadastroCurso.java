...
public class CadastroCurso extends javax.swing.JPanel {
    ...
    private void txtCargaHorariaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCargaHorariaFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCargaHorariaFocusLost
    ...
    private void configTela() {
        switch (util.TELA_ATUAL) {
            case util.TELA_CAD_CURSO: {
                lbTitulo.setText("NOVO CURSO");
                txtNome.setText(" Nome do curso");
                break;
            }
            case util.TELA_CAD_PROJETO: {
                lbTitulo.setText("NOVO PROJETO");
                txtNome.setText(" Nome do projeto");
                break;
            }
        }
    }
    ...
    private void cadCurso() throws ParseException, SQLException {
        CursoDao cdao = new CursoDao();
        Curso c = new Curso();

        java.sql.Date dtInicioMillis = util.converteEmMilissegundos(txtDataInicio.getText());
        java.sql.Date dtFimMillis = util.converteEmMilissegundos(txtDataFim.getText());

        c.setNome(txtNome.getText());
        c.setResponsavel(txtResponsavel.getText());
        c.setDescricao(txtDescricao.getText());
        c.setCargaHoraria(Integer.parseInt(txtCargaHoraria.getText()));
        c.setDataInicio(dtInicioMillis);
        c.setDataFim(dtFimMillis);

        cdao.adicionar(c);
        JOptionPane.showMessageDialog(this, "Curso criado com sucesso!");
    }

    private void cadProjeto() throws ParseException, SQLException {
        ...
        p.setCargaHoraria(Integer.parseInt(txtCargaHoraria.getText()));
        p.setDataInicio(dtInicioMillis);
        p.setDataFim(dtFimMillis);
